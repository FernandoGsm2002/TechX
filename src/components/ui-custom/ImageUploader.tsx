...
import { Upload, X, ImageIcon, Loader2, RefreshCw, ZoomIn } from "lucide-react";
        ...
        {!displayUrl && !uploading && (
          <>
            <div className={cn(
              ...
              <ImageIcon className={cn("size-6", dragging ? "text-primary" : "text-muted-foreground/60")} />
            </div>
          ...
          <>
            ...
            <div className="absolute bottom-0 left-0 right-0 flex items-center justify-center py-1 bg-gradient-to-t from-black/60 to-transparent opacity-0 hover:opacity-100 transition-opacity">
              <p className="text-[10px] text-white/80 flex items-center gap-1">
                <Upload className="size-2.5" /> Reemplazar
              </p>
            </div>
          </>
        )}
