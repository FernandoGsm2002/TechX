...
import {
  faClockRotateLeft, faArrowDown, faArrowUp, faBox, faXmark,
      ...
      <SheetContent className="w-full sm:max-w-md flex flex-col p-0 gap-0">
        ...
        <div className="flex-1 overflow-y-auto">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 gap-3 text-muted-foreground">
              <FaIcon icon={faClockRotateLeft} size={36} className="opacity-20" />
                ...
                return (
                  <div key={m.id} className="flex items-start gap-3 px-5 py-3.5 hover:bg-muted/20 transition-colors">
                    ...
                    <div className={cn(
                      ...
                      {isIn
                      ? <FaIcon icon={faArrowDown} size={14} className="text-emerald-400" />
                      : <FaIcon icon={faArrowUp} size={14} className="text-red-400" />
                    }
                    </div>
        ...
        <div className="px-5 py-3 border-t border-border/40 shrink-0 flex items-center justify-between text-xs text-muted-foreground">
          ...
          <Button size="sm" variant="ghost" onClick={() => onOpenChange(false)}>
            <FaIcon icon={faXmark} size={12} className="mr-1" /> Cerrar
          </Button>
        </div>
      </SheetContent>
    </Sheet>
