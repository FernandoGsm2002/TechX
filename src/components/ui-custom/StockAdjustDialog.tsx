...
import {
  faMagnifyingGlass, faMinus, faPlus, faBox, faSpinner, faCircleCheck,
  faArrowsUpDown, faXmark, faCircleInfo,
  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        {selected && <FaIcon icon={faCircleCheck} size={10} className="text-primary-foreground" />}
      </div>
      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] flex flex-col overflow-hidden p-0">
        ...
        <div className="px-6 pt-5 pb-4 border-b border-border/50 shrink-0 space-y-3">
          <div className="flex items-center gap-3">
            <div className="flex size-9 items-center justify-center rounded-xl bg-blue-500/15">
              <FaIcon icon={faArrowsUpDown} size={18} className="text-blue-400" />
            </div>
            <div>
        ...
        <div className="px-6 pt-3 shrink-0">
          ...
          {n > 0 && (
            <div className="flex items-center justify-between mt-2 px-1">
              ...
              >
                <FaIcon icon={faXmark} size={10} className="mr-0.5" /> Limpiar selección
              </button>
            </div>
          )}
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-3 space-y-1.5">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-10 text-muted-foreground gap-2">
              <FaIcon icon={faBox} size={28} className="opacity-30" />
        ...
        {n > 0 && !done && (
          <div className="px-6 py-3 border-t border-border/40 bg-muted/20 shrink-0">
            <div className="flex items-center gap-2 flex-wrap">
              <FaIcon icon={faCircleInfo} size={13} className="text-muted-foreground shrink-0" />
        ...
        {done && (
          <div className="px-6 py-4 border-t border-border/40 shrink-0 flex items-center justify-between gap-3 bg-emerald-500/5">
            <div className="flex items-center gap-2">
              <FaIcon icon={faCircleCheck} size={18} className="text-emerald-400" />
        ...
        {!done && (
          <div className="px-6 pb-5 pt-3 border-t border-border/40 flex items-center justify-between shrink-0">
            ...
            >
              {saving
                ? <><FaIcon icon={faSpinner} size={14} className="animate-spin" /> Aplicando...</>
                : <><FaIcon icon={faArrowsUpDown} size={14} /> Aplicar a {n} ítem{n !== 1 ? "s" : ""}</>
              }
            </Button>
          </div>
        )}
