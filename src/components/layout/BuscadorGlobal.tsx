...
import {
  faMagnifyingGlass, faXmark, faSpinner, faTicket, faBox, faCartShopping, faBolt,
...
// ── Icon por tipo ──────────────────────────────────────────────────────────────
const typeIcon: Record<GlobalResultType, IconDefinition> = {
  ticket:    faTicket,
  servicio:  faBolt,
  inventory: faBox,
  sale:      faCartShopping,
  ...
  return (
    <div ref={containerRef} className="relative w-full max-w-xs lg:max-w-sm">
      ...
      <div className={cn(
        ...
        {isLoading
          ? <FaIcon icon={faSpinner} size={14} className="text-muted-foreground animate-spin" />
        ...
        <div className={cn(
          ...
          {results.length === 0 && !isLoading ? (
            <div className="flex flex-col items-center justify-center py-8 text-muted-foreground gap-2">
              <FaIcon icon={faMagnifyingGlass} size={28} className="opacity-30" />
                  ...
                  <li key={`${r.type}-${r.id}`}>
                    ...
                    >
                      ...
                      <span className={cn(
                        ...
                        <FaIcon icon={typeIcon[r.type]} size={14} />
                      </span>
