  ...
  public: {
    Tables: {
      collection_tasks: {
        ...
        Relationships: [
          {
            foreignKeyName: "collection_tasks_assigned_by_fkey"
            columns: ["assigned_by"]
            isOneToOne: false
      ...
      organizations: {
        Row: {
          ...
          is_active: boolean
          is_approved: boolean
          last_deuda_notif_at: string | null
      ...
      receipts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "receipts_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: false
            referencedRelation: "tickets"
            referencedColumns: ["id"]
      ...
      servicio_counters: {
        ...
        Relationships: [
          {
            foreignKeyName: "servicio_counters_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: true
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      ticket_counters: {
        ...
        Relationships: [
          {
            foreignKeyName: "ticket_counters_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: true
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      next_servicio_number: { Args: { org_id: string }; Returns: number }
      next_ticket_number: { Args: { org_id: string }; Returns: number }
      reject_organization: { Args: { org_id: string }; Returns: undefined }
      show_limit: { Args: never; Returns: number }
      show_trgm: { Args: { "": string }; Returns: string[] }
      void_sale_transactional: {
        Args: { p_reason: string; p_sale_id: string; p_voided_by: string }
        Returns: undefined
      }
    }
    Enums: {
