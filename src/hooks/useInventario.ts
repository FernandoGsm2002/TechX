...
// id, organization_id, name, brand, model, category, sku, condition, quality,
// quantity, cost_price, sell_price, notes, item_type, image_url, min_stock, created_at, updated_at
